...
namespace API.Controllers.ParamsControllers
{
    ...
    [ApiController]
    public class StampTaxController : ControllerBase
    {
        private readonly IParamsService<StampTax> _service;

        public StampTaxController(IParamsService<StampTax> service)
        {
            _service = service;
        }

        [HttpPost]
        public async Task<IActionResult> Add(StampTax entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, StampTax entity)
        {
