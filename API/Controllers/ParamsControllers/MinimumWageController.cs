...
namespace API.Controllers.ParamsControllers
{
    ...
    {
        private readonly IParamsService<MinimumWage> _service;

        public MinimumWageController(IParamsService<MinimumWage> service)
        {
            _service = service;
        }

        [HttpPost]
        public async Task<IActionResult> Add(MinimumWage entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, MinimumWage entity)
        {
