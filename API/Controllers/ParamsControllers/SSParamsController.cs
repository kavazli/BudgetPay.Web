...
namespace API.Controllers.ParamsControllers
{
    ...
    [ApiController]
    public class SSParamsController : ControllerBase
    {
        private readonly IParamsService<SSParams> _service;

        public SSParamsController(IParamsService<SSParams> service)
        {
            _service = service;
        }

        [HttpPost]
        public async Task<IActionResult> Add(SSParams entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(Guid id, SSParams entity)
        {
